  ...
  return (
     ...
     >
       ...
       <div className="flex-shrink-0 ml-auto">
         <Link  href={`/doctors/${doctor._id}`} className="bg-[#F87171] text-white text-xs px-3 py-1 rounded-full flex items-center transition-all duration-300 ease-in-out group-hover:bg-[#e05252]">
           View Details
